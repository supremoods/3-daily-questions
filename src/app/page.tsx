...
export default function Home() {
  ...
  return (
    <div className="bg-secondary flex justify-center">
      <div className="flex flex-col min-h-screen w-[1085px] ">
        <div className="min-h-screen flex flex-col items-center  p-24 justify-center">
          <LandingPage scroll={scrollToQuizzes} />
        </div>
        <div ref={quizzesRef} className='min-h-screen flex flex-col items-center justify-center p-24 '>
          <Quizzes />
        </div>
      </div>
    </div>
